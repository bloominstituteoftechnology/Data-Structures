...
class LRUCache:
    ...
    def __init__(self, limit=10):
        self.limit = limit
        self.storage = {} # storage dict that provides fast access to every node stored
        self.amount = len(self.storage.keys()) #current number of nodes it is holding
        self.record = DoublyLinkedList() # a doubly-linked list that holds the key-value entries
