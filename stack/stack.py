...
Notes: Stack implements LIFO (last in first out)
lookup O(n), pop O(1), push O(1), peek O(1)  
ex: browser history
//can build stacks with arrays or linked lists --> both work well. Arrays allow cache locality. Linked lists have more dynamic memory.
