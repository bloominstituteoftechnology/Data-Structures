...
class LRUCache:
    ...
    2.the current number of nodes it is holding #how does it know know the number of nodes? doublylinked list has length attribute
    ...
    2.move the key-value pair to the end of the order (tail) such that the pair is considered most-recently used.
    3.Returns the value associated with the keyor None if the key-value pair doesn't exist in the cache.
    """
    def get(self, key):
    ...
    """
    Adds the given key-value pair to the cache. The newly-added pair should be considered the most-recently used entry in the cache.(to the head) 
