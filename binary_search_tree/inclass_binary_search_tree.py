...
class BSTNode:
    ...
    def in_order_print(self):
        ...
        # Iterative - think  about the order in which we are adding nodes to
        # the stack
    ...
    def dft_print(self):
        ...
        # while something is still in stack (not done processing)
            # use existing 'for_each()' as reference for traversal logic
