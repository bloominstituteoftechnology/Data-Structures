...
10. What is the runtime complexity of `DoublyLinkedList.delete`? O(n)
    ...
    a. Compare the runtime of the doubly linked list's `delete` method with the worst-case runtime of the JS `Array.splice` method. Which method generally performs better? My guess is the array has a better performance.
