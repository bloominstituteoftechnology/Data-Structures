class Heap:
  ...
  def delete(self):
    ...
    self.storage.pop()
    #call _sift_down to move the lement at index 1 down  to a valid spot in heap
    self._sift_down(1)
    return retval
  ...
  def _bubble_up(self, index):
    #keep bubbling the element at the given index up the heap it reaches a valid spot
  ...
  def _sift_down(self, index):
    # keep sifting the elemnt at the given index down the heap until it reaches a valid spot
