...
class DoublyLinkedListTests(unittest.TestCase):
  ...
  def test_list_remove_from_head(self):
    ...
    self.dll.add_to_head(66)

    self.assertEqual(len(self.dll), 2)
    self.assertEqual(self.dll.head.value, 66)
    self.assertEqual(self.dll.head.next.value, 55)
    self.assertEqual(self.dll.tail.value, 55)
    self.assertEqual(self.dll.tail.prev.value, 66)

    self.assertEqual(self.dll.remove_from_head(), 66)

    self.assertEqual(self.dll.head.value, 55)
  ...
  def test_list_remove_from_tail(self):
    ...
    self.dll.add_to_tail(69)
    
    self.assertEqual(len(self.dll), 2)
    self.assertEqual(self.dll.head.value, 68)
    self.assertEqual(self.dll.head.next.value, 69)
    self.assertEqual(self.dll.tail.value, 69)
    self.assertEqual(self.dll.tail.prev.value, 68)
    
    self.assertEqual(self.dll.remove_from_tail(), 69)
    
    self.assertEqual(len(self.dll), 1)
    self.assertEqual(self.dll.head.value, 68)
    self.assertEqual(self.dll.head.next, None)
    self.assertEqual(self.dll.tail.value, 68)
    self.assertEqual(self.dll.tail.prev, None)
  ...
  def test_list_move_to_front(self):
    ...
    self.assertEqual(self.dll.head.next.value, 1)
    self.assertEqual(self.dll.tail.value, 1)
    self.assertEqual(self.dll.tail.prev.value, 3)
    self.assertEqual(len(self.dll), 2)
    ...
    self.assertEqual(self.dll.head.next.next.value, 1)
    self.assertEqual(self.dll.head.next.next.prev.value, 29)
    self.assertEqual(self.dll.tail.value, 1)
    self.assertEqual(self.dll.tail.prev.value, 29)
    self.assertEqual(len(self.dll), 3)
  ...
  def test_list_move_to_end(self):
    ...
    self.assertEqual(self.dll.head.value, 1)
    self.assertEqual(self.dll.head.next.value, 4)
    self.assertEqual(self.dll.head.next.next.value, 40)
    self.assertEqual(self.dll.head.next.next.prev.value, 4)
    self.assertEqual(self.dll.tail.value, 40)
  ...
  def test_get_max(self):
    ...
    self.dll.remove_from_tail()
    self.dll.remove_from_tail()
    self.assertEqual(self.dll.get_max(), None)
